...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="categoey.php"> Product </a>
        </li>
        <li class="nav-item">
          ...
          <a href="shopping.php"><i class='bx bx-cart' style="font-size: 35px; "></i></a>
...
?></h5><a href="profile.php"> <i class='bx bx-user' style="font-size: 35px;"></i></a>
  ...
  <div class="card-body">
    ...
    <form action='functions/cart.php?root=../homepageuser.php&id=<?php echo $display_news[$i+($a*3)]['product_id'] ?>' method='Post'>
   <button  type="submit" class="btn btn-primary" name="add_cart">Add to cart <i class='bx bx-cart' ></i></button>
    </form>
  </div>
  </div>
...
<div class="bestseller">
  ...
  <div class="card-body">
    ...
    <form action='functions/cart.php?root=../homepageuser.php&id=<?php echo $display_topsales[$i+($a*3)]['product_id'] ?>' method='Post'>
   <button  type="submit" class="btn btn-primary" name="add_cart">Add to cart <i class='bx bx-cart' ></i></button>
    </form>
  </div>
  </div>
