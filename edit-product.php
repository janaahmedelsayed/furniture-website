        ...
        <div class="row tm-edit-product-row">
          ...
          <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
            <div class="tm-product-img-edit mx-auto">
              <img id="previewImage" src="img/placeholder.jpg" alt="Placeholder" class="img-fluid d-block mx-auto">
              <i
            ...
            <div class="custom-file mt-3 mb-3">
              <input id="fileInput"  name="image" type="file" style="display:none;" onchange="previewFile()" >
              <input
